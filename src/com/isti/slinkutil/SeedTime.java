...
public class SeedTime {
  ...
  /**
   * Project the time for the specified number of samples and sample rate. Note
   * this is not the time of the last sample, but rather the predicted begin
   * time of the next record. For the last sample time subtract one from the
   * number of samples.
  ...
  public String toString() {
    return btime.year + "." + btime.jday + " " + btime.hour + ":" + btime.min
        + ":" + btime.sec + "." + btime.tenthMilli;
  }
   ...
   * Returns the 'Btime' value.
   * @param time the milliseconds since 1/1/1970 GMT.
   * @param useCalFlag true to use a calendar, false otherwise.
   * @return the 'Btime' value.
   */
   ...
   * this is not the time of the last sample, but rather the predicted begin
   * time of the next record. For the last sample time subtract one from the
   * number of samples. This code was lifted from the
   * 'kmi.smarts.module.rtslsup.seisFile.mseed.DataHeader.projectTime' method.
   * @param btime the 'Btime' value.
   * @param numSamples the number of samples.
   * @param sampleRate the sample rate.
   */
  public static void projectTime(Btime btime, int numSamples, double sampleRate) {
